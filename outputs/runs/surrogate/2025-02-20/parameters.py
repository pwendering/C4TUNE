# -*- coding: utf-8 -*-
"""
Training with optimal parameters + linear lr scheduler which resets every 15 epochs
Every 15 epochs, the reference learning rate is also reduced by 50%.
...
cp_for_enrichment = checkpoint_dir + "2025_02_14_2/" + "surrogate-model-full-epoch-30.pth"
