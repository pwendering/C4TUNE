...
WeatherWind=envFactor.WeatherWind;
...
KmATP_78=KValue(7,1);  KmPGA_78=KValue(7,2); % KmNADPH_78Mchl=KValue(7,1); 
...
KmATP_78Mchl=KValue(19,1);  KmPGA_78Mchl=KValue(19,2);
...
KmPGA_B =KValue(55,1); KmGAP_B =KValue(55,2); KmDHAP_B =KValue(55,3); 
KmPGA_M =KValue(56,1); KmGAP_M =KValue(56,2); KmDHAP_M =KValue(56,3);
ki=KValue(57,1);  kd=KValue(57,2);
...
Vm_10=Velocity_s(8)*TempCorr_Vm_Enz;
Vm_11=Velocity_s(9)*TempCorr_Vm_Enz;
Vm_12=Velocity_s(10)*TempCorr_Vm_Enz;
Vm_13=Velocity_s(11)*TempCorr_Vm_Enz;
Vm_14=Velocity_s(12)*TempCorr_Vm_Enz;
Vm_15=Velocity_s(13)*TempCorr_Vm_Enz;
Vm_18=Velocity_s(14)*TempCorr_Vm_Enz;
Vm_78Mchl=Velocity_s(15)*TempCorr_Vm_Enz;
% Vm_Starch=Velocity_s(16);
Vm_PGASink=Velocity_s(16)*TempCorr_Vm_Enz;
Vm_Suc1=Velocity_s(17)*TempCorr_Vm_Enz;
Vm_Suc2=Velocity_s(18)*TempCorr_Vm_Enz;
Vm_Suc7=Velocity_s(19)*TempCorr_Vm_Enz;
Vm_Suc8=Velocity_s(20)*TempCorr_Vm_Enz;
Vm_Suc9=Velocity_s(21)*TempCorr_Vm_Enz;
Vm_Suc10=Velocity_s(22)*TempCorr_Vm_Enz;
Vm_Suc3=Velocity_s(23)*TempCorr_Vm_Enz;
Vm_Suc4=Velocity_s(24)*TempCorr_Vm_Enz;
Jmax=Velocity_s(25)*TempCorr_Jmax;
Vm_ATPM=Velocity_s(26)*TempCorr_Vm_Enz;
Vm_NADPHM=Velocity_s(27)*TempCorr_Vm_Enz; 
...
Vm_PR5=Velocity_s(34)*TempCorr_Vm_Enz;
Vm_PR6=Velocity_s(35)*TempCorr_Vm_Enz;
Vm_PR7=Velocity_s(36)*TempCorr_Vm_Enz;
Vm_PR8=Velocity_s(37)*TempCorr_Vm_Enz;
VTgca_PR9=Velocity_s(38)*TempCorr_Vm_Enz;
VTgcea_PR10=Velocity_s(39)*TempCorr_Vm_Enz;
Vm_62=Velocity_s(40)*TempCorr_Vm_Enz;
Vtp_Bchl=Velocity_s(41)*TempCorr_Vm_Enz;
Vtp_Mchl=Velocity_s(42)*TempCorr_Vm_Enz;
Vm_Sta1=Velocity_s(43)*TempCorr_Vm_Enz;
Vm_Sta2=Velocity_s(44)*TempCorr_Vm_Enz;
Vm_Sta3=Velocity_s(45)*TempCorr_Vm_Enz;
Vm_OAA_M=Velocity_s(46)*TempCorr_Vm_Enz;
Vm_PYR_B=Velocity_s(47)*TempCorr_Vm_Enz;
Vm_PYR_M=Velocity_s(48)*TempCorr_Vm_Enz;
Vm_PEP_M=Velocity_s(49)*TempCorr_Vm_Enz;
Vm_PEP_B=Velocity_s(50)*TempCorr_Vm_Enz;
Vm_MAL_B=Velocity_s(51)*TempCorr_Vm_Enz; %*TempCorr_Vm_Enz;
Vm_MAL_M=Velocity_s(52)*TempCorr_Vm_Enz; %*TempCorr_Vm_Enz;
Vm_Hep=Velocity_s(53)*TempCorr_Vm_Enz; 


%% Permeabilities

Pmal=Perm(1)*TempCorr_Vm_Enz;
Ppyr=Perm(2)*TempCorr_Vm_Enz;
...
tao_ActPEPC =Act_rate(1);
tao_ActFBPase =Act_rate(2);
tao_ActSBPase =Act_rate(3);
tao_ActATPsynthase=Act_rate(4);
tao_ActGAPDH=Act_rate(5);
tao_ActPRK=Act_rate(6);
tao_ActNADPMDH=Act_rate(7);
KaRac=Act_rate(8);
...
% fprintf("Time: %4.2f, Air_CO2: %4.2f, MC_PEP: %4.2f, MCPi: %4.2f \n",t, Air_CO2,MC_PEP,MC_Pi)
MC_PPi = MC_PiT-MC_Pi;
...
vGAP_M=Vtp_Mchl * Mchl_GAP/(Mchl_GAP + KmGAP_M * ( 1 + Mchl_PGA/KmPGA_M) * ( 1 + Mchl_DHAP/KmDHAP_M))-Vtp_Mchl * MC_GAP/(MC_GAP + KmGAP_M * ( 1 + MC_PGA/KmPGA_M) * ( 1 + MC_DHAP/KmDHAP_M));
vDHAP_M=Vtp_Mchl * Mchl_DHAP/(Mchl_DHAP + KmDHAP_M * ( 1 + Mchl_PGA/KmPGA_M) * ( 1 + Mchl_GAP/KmGAP_M))-Vtp_Mchl * MC_DHAP/(MC_DHAP + KmDHAP_M * ( 1 + MC_PGA/KmPGA_M) * ( 1 + MC_GAP/KmGAP_M));
...
% fprintf("time: %4.2f, gs steady: %4.2f\n", t, Gsw0)
...
%  fprintf("time: %4.2f, kd_Gs: %4.2f, ki_Gs: %4.2f \n", t, kd_Gs, ki_Gs)
if GsResponse==0
    Gs=Gs0;
    Gsw=Gsw0;
    vgs=0;
